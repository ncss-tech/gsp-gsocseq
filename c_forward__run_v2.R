...
names(rc_fr_bau) <- names(rc_fr_baumax)
...
saveRDS(rc_fr_final, file = "z_rothC_fr_final.rds")
write_sf(rc_fr_final, dsn = "z_rothC_fr_final.gpkg", driver = "GPKG", overwrite = TRUE) 
